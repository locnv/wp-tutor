			...
			var retHtml = `
				<div class="row">
					...
					<div class="one-third">
						...
						${results.professors.length > 0 ? '<ul class="professor-cards">' : `<p>No Professors match that search.</p>`}
					...
					<div class="one-third">
						...
						${results.events.length > 0 ? '' : `<p>No events match that search. <a href="${siteInfo.rootUrl}/events">View all events</a>.</p>`}
